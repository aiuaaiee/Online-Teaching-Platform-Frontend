        ...
        <div id="content4">
           <!-- TABLE -->
            <table class="table table-responsive">
                ...
                <?php
                    $query = mysqli_query($mysqli,"SELECT * FROM teachregs WHERE status = 'Confirmed' ORDER BY id");
            ...
            <div class="wrapper">
                ...
                <nav id="sidebar">
                   ...
                   <ul class="list-items">
                      ...
                      <li><a href="../applications.php"><i class="fas fa-users" style="color: white;"></i>Applications</a></li>
                      <div class="dropdown">
